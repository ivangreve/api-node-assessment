const {
  ...
  findByEmail,
  createUserToken
} = require("../services/clients.service.js");

test("Should return Whitley client object", () => {
  const objFound = findByName(mockedClients, "Whitley");
  const expectedObj = {
...
test("Should create and return a correctly token obj", () => {
  const user = {
    ...
    role: "admin",
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImU4ZmQxNTliLTU3YzQtNGQzNi05YmQ3LWE1OWNhMTMwNTdiYiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTU5MjMzODA0OH0.bvnzWsOO36pbvd1P959SZw36cqxXlkE6JPn0Evf_kG0"
  };
